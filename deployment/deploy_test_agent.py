...
flags.DEFINE_string("project_id", None, "yuchida-dev")
flags.DEFINE_string("location", None, "us-central1")
flags.DEFINE_string("bucket", None, "gs://nba-analytics-agent-staging")
flags.DEFINE_string(
    "resource_id",
    None,
